...
public class GroupModeInsertRequest implements Serializable {
	...
	public String toString() {
		...
		builder.append("GroupModeInsertRequest [modename=");
	...
	public GroupModeInsertRequest(String modename, int modeid, int groupid, List<DeviceBean> devices) {
		super();
