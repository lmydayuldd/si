...
public class SpareCategoryInsertProcess extends AbstractAuthAPIProcess {

	private final SpareCategoryInsertRequest entity;
	private final String STEP = "2";

	public SpareCategoryInsertProcess(final SpareCategoryInsertRequest entity) {
	...
	protected Object process() throws SiDCException, Exception {
		// TODO Auto-generated method stub
		final int id = SpareManager.getInstance().insertCategory(entity.getStatus(), entity.getSequence(),
				entity.getList(), entity.getPhotolist());
		LogAction.getInstance().debug("step 1/" + STEP + ":insert success(SpareManager|insertCategory).");
