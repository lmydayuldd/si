 ...
 *
 */
public class ShoppingUpdateProcess extends AbstractAuthAPIProcess {

	private ShoppingListUpdateRequest enity;
	
	public ShoppingUpdateProcess(ShoppingListUpdateRequest enity) {
	...
	protected Object process() throws SiDCException, Exception {
		...
		if (!isUnpost) {
			throw new SiDCException(APIStatus.ILLEGAL_ARGUMENT, "Order has been set up, commodity processing.");
		}
