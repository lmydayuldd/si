 ...
 *
 */
public class LaundryClassInsertProcess extends AbstractAuthAPIProcess {

	private final LaundryClassInsertRequest entity;
	private final String STEP = "1";

	public LaundryClassInsertProcess(final LaundryClassInsertRequest entity) {
	...
	protected Object process() throws SiDCException, Exception {
		...
		final int id = LaundryServiceManager.getInstance().insertClass(entity.getStatus(), entity.getServicecharge(),
				entity.getList());
		LogAction.getInstance().debug("step 1/" + STEP + " :insert success(LaundryServiceManager|insertClass).");
