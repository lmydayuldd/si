...
public class ShoppingCategoryInsertProcess extends AbstractAuthAPIProcess {

	private final ShoppingCategoryInsertRequest entity;
	private final String STEP = "2";

	public ShoppingCategoryInsertProcess(final ShoppingCategoryInsertRequest entity) {
	...
	protected Object process() throws SiDCException, Exception {
		// TODO Auto-generated method stub
		final int id = ShopManager.getInstance().insertCategory(entity.getStatus(), entity.getSequence(),
				entity.getReferid(), entity.getList(), entity.getPhotolist());
		LogAction.getInstance().debug("step 1/" + STEP + ":insert success(ShopManager|insertCategory).");
	...
	protected void check() throws SiDCException, Exception {
		...
		if (entity.getReferid() > 0 && !ShopManager.getInstance().isExistByCategoryId(entity.getReferid())) {
