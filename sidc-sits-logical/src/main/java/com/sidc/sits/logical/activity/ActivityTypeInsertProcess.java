 ...
 *
 */
public class ActivityTypeInsertProcess extends AbstractAuthAPIProcess {

	private final ActivityTypeInsertRequest entity;
	private final String STEP = "1";

	public ActivityTypeInsertProcess(final ActivityTypeInsertRequest entity) {
	...
	protected Object process() throws SiDCException, Exception {
		...
		final int id = ActivityManager.getInstance().insertType(entity.getStatus(), entity.getList());
		LogAction.getInstance().debug("step 1/" + STEP + " :insert success(ActivityManager|insertType).");
