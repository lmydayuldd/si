...
public class ShoppingVendorUpdateProcess extends AbstractAuthAPIProcess {

	private final ShoppingVendorUpdateRequest entity;
	private final String STEP = "1";

	public ShoppingVendorUpdateProcess(final ShoppingVendorUpdateRequest entity) {
	...
	protected Object process() throws SiDCException, Exception {
		// TODO Auto-generated method stub
		ShopManager.getInstance().updateVendor(entity.getVendorid(), entity.getStatus(), entity.getTex(),
				entity.getEmail(), entity.getAddress(), entity.getList());
		LogAction.getInstance().debug("step 1/" + STEP + ":insert success(ShopManager|updateVendor).");
	...
	protected void check() throws SiDCException, Exception {
		...
		if (entity.getVendorid() <= 0) {
			throw new SiDCException(APIStatus.ILLEGAL_ARGUMENT, "request illegal(vendor idO).");
		}
		...
		if (!ShopManager.getInstance().isExistByVendorId(entity.getVendorid())) {
