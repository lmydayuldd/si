 ...
 *
 */
public class RcuSenderLog {

	private final static Logger logger = LoggerFactory.getLogger(RcuSenderLog.class);

	private ThreadLocal<SenderRcuLogBean> threadLocal = new ThreadLocal<SenderRcuLogBean>();

	private static class SingletonHolder {
		private static RcuSenderLog instance = new RcuSenderLog();
	}

	private RcuSenderLog() {
	}

	public static RcuSenderLog getInstance() {
