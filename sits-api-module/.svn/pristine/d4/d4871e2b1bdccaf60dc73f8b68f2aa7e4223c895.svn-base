...
public class TvChannelBean implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9120536664840625895L;
	private String id;
	...
	public String toString() {
		...
		builder.append("TvChannelBean [id=");
		builder.append(id);
	...
	public TvChannelBean(String id, String channelno, int sequence, String name, String iplowbitrate, String port) {
		super();
		this.id = id;
