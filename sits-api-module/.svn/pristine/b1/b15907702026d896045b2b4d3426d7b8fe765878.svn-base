...
public class ActivityInsertRequest implements Serializable {
	private static final long serialVersionUID = -7121663219732557444L;
	...
	public String toString() {
		...
		builder.append("ActivityInsertRequest [token=");
	...
	public ActivityInsertRequest(String token, int type, String repeattype, int lowerlimit, int upperlimit, int target,
			...
			List<ActivityRepeatBean> repeatlist, List<ActivityPhotoUploadBean> photolist) {
		super();
		this.token = token;
		this.type = type;
