...
public class LaundryOrderListResponse implements Serializable {
	private static final long serialVersionUID = -4381284448080588632L;
	private int orderid;
	...
	public String toString() {
		...
		builder.append("LaundryOrderListResponse [orderid=");
	...
	public LaundryOrderListResponse(int orderid, String status, String receivetime, int classid, String classname,
			int totalpieces, float subtotal, float servicecharge, float amount, String memo, String creationtime) {
		super();
