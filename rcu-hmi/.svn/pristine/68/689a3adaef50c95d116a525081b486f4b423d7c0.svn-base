...
<script type="text/template" id="tpl_room_list">
  <table id="example2" class="table table-bordered table-hover">
    <thead>
      <tr>
        <th>Room No</th>
        <th style="width: 125px;">Check in Status</th>
        <th>TYPE</th>
        <th>Other Status</th>
        <th></th>
      </tr>
    ...
    <tbody>
      {{#each arr}}
        <tr>
          <td>{{roomNo}}</td>
          <td>normal</td>
          <td class="text-center"><span class="label label-success"><i class="fa fa-user"></i></span></td>
          <td>
            <span class="label label-danger">RCU</span>
            <span class="label label-danger">LAUNDRY</span>
            <span class="label label-danger">BULTER</span>
            <span class="label label-danger">SOS</span>
            <span class="label label-danger">SOS</span>
          </td>
          <td>
