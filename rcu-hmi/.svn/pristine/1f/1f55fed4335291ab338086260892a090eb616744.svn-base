<!-- /.sidebar sidebar: style can be found in sidebar.less -->
<section class="sidebar">
  ...
  <ul class="sidebar-menu">
   ...
   <!--  <li class="active treeview">
    ...
    <li>
      <a href="<%=request.getContextPath() %>/admin/pages/room.jsp">
   ...
   <!--  <li>
    ...
    <li>
      <a href="<%=request.getContextPath() %>/admin/pages/schedule_control.jsp">
        <i class="fa fa-gear"></i> <span>CheckOut排程設定</span>
      </a>
    </li>
   <!--  <li>
      <a href="rcu.jsp">
        <i class="fa fa-bookmark"></i> <span>RCU Status</span>
      </a>
    </li>
    <li>
      <a href="room_setting.jsp">
        <i class="fa fa-bookmark"></i> <span>Room Setting</span>
      </a>
    </li> -->
    <!-- <li class="treeview">
      <a href="#">
