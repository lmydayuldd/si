...
import com.sidc.rcu.hmi.logical.mode.RcuModeDeviceInsertProcess;
...
public class RcuModeDeviceSettingInsertServlet extends APIServlet {
	...
	protected Object execute(String apiRequest) throws SiDCException, Exception {
		...
		final RcuModeDeviceInsertRequest entity = (RcuModeDeviceInsertRequest) APIParser.getInstance()
				.parses(apiRequest, RcuModeDeviceInsertRequest.class);
