...
import com.sidc.rcu.hmi.logical.modesetting.RcuGroupModeSettingProcess;
import com.sidc.rcu.hmi.modesetting.request.ModeSettingListRequest;
import com.sidc.utils.exception.SiDCException;
import com.sidc.utils.log.LogAction;

@WebServlet("/group/mode/setting")
public class RcuGroupModeServlet extends APIServlet {
	private static final long serialVersionUID = 1544764573967086799L;
	private final static Logger logger = LoggerFactory.getLogger(RcuGroupModeServlet.class);
	...
	protected Object execute(String apiRequest) throws SiDCException, Exception {
		...
		return new RcuGroupModeSettingProcess(entity).execute();
	}
