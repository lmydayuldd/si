...
public class ScheduleDataProcess extends AbstractAPIProcess {

	private final ScheduleDataRequest enity;
	
	public ScheduleDataProcess(ScheduleDataRequest enity) {
