...
public class RCUBulbCommandProcess extends AbstractAuthAPIProcess {
	private final MobileCommanderRequeset entity;
	private RcuCommanderBean commandEntity;

	public RCUBulbCommandProcess(final MobileCommanderRequeset entity, final String ip) {
	...
	protected Object process() throws SiDCException, Exception {
		...
		final BulbCommander bulbCommander = new BulbCommander((int) Double.parseDouble(commandEntity.getValue()));
		LogAction.getInstance().debug("step 2/3 bulbCommander entity:" + bulbCommander);
