...
public class RcuGroupModeInsertProcess extends AbstractAPIProcess {
	private final RcuGroupModeInsertRequest entity;
	private final String step = "";

	public RcuGroupModeInsertProcess(final RcuGroupModeInsertRequest entity) {
		this.entity = entity;
	}
	...
	protected Object process() throws SiDCException, Exception {
		...
		RcuModeManager.getInstance().insertGroupMode(entity.getGroupid(), entity.getModeid(),
				gson.toJson(new RcuModeBean(catalogues)));
		LogAction.getInstance().debug("step 4/" + step + ":insert success(RcuModeManager|insertGroupMode).");
