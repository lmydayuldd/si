...
import com.sidc.ra.server.udp.receiver.RcuHeartbeatReceiver;
...
public class UDPServer extends Thread implements UDPProtocolIntf {
	...
	private WebSocketClient indexWebsocketClient(WebSocketClient client) throws InterruptedException {
	...
	private void catalogueProcess(UdpRreceiveBean entity) throws SiDCException, Exception {
