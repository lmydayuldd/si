...
public interface CommonDataKey {
	public final static String LOCAL_ADRESS = "LocalAdress";
	...
	public final static String RCU_BULB = "RcuBulb";

	public final static String RCU_CARD = "RcuCard";

	public final static String RCU_ROOM_STATUS = "RcuRoomStatus";// 心跳

	public final static String RCU_HVAC_INFO = "RcuHvacInfo";// 冷氣

	public final static String RCU_ROOM_TYPE = "RcuRoomType";// 房型
	...
	public final static String WEBSOCKET_INDEX_INFO = "WebsocketIndexInfo";// 首頁socket
