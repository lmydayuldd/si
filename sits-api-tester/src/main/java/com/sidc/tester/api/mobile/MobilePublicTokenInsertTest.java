...
public class MobilePublicTokenInsertTest {
	...
	@Test
	public void test() {
		MobilePublicTokenInsertRequest MobilePublicTokenInsertRequest = new MobilePublicTokenInsertRequest("608", 0);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://10.60.1.251:7056/blackcore/mobile/token/publicinsert");
