...
public class CheckInTest {
	...
	public void test() {
		...
		HttpPost httppost = new HttpPost("http://10.60.3.251:7056/blackcore/checkin");

		List<GuestRequest> guestList = new ArrayList<GuestRequest>();

		// guestList.add(new GuestRequest("", "AAA", "BBBB", "2017/08/16",
		// "2017/12/09","girl" ));
		guestList.add(new GuestRequest("", "黃富軍", "", null, "", ""));

		// Request parameters and other properties.
		APIRequest enity = new APIRequest(new CheckInRequest("805", "2017/09/7", guestList, "zh_tw", null, null));
		Gson gson = new Gson();
