...
public class TvChannelChangeTest {
	...
	public void test() {
		...
		HttpPost httppost = new HttpPost("http://10.60.1.39:7056/blackcore/stb/tvchannelchange");

		APIRequest enity = new APIRequest(new TvChannelChangeRequest("1", "2", "610", "04", "03"));
		Gson gson = new Gson();
