...
public class LaundryItemUpdateTest {
	...
	public void test() throws Exception {
		...
		list.add(new LaundryLangBean("zh_TW", "夾克/外套", "外套"));
		list.add(new LaundryLangBean("en_US", "Jacket/Coat"));
		...
		LaundryItemUpdateRequest request = new LaundryItemUpdateRequest("token", 2, 0, 1, list, washtypelist,
				returntypelist, photoList, true);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://10.60.1.39:7056/blackcore/sits/laundryservice/itemupdate");
