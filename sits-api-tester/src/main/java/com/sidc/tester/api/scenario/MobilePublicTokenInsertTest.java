...
public class MobilePublicTokenInsertTest {
	...
	@Test
	public void test() {
		MobilePublicTokenInsertRequest MobilePublicTokenInsertRequest = new MobilePublicTokenInsertRequest("302", 0);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://61.221.235.26:7056/blackcore/mobile/token/publicinsert");
