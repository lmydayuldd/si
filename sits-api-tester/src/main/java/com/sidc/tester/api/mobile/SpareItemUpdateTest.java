...
public class SpareItemUpdateTest {
	...
	public void test() throws Exception {
		...
		SpareItemUpdateRequest request = new SpareItemUpdateRequest("86f6ffa3-2d69-4389-b044-664b2a3ba130", 4, 7, "10",
				77, (float) 77, 77, list, photoList, true);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://10.60.1.39:7056/blackcore/sits/spare/itemupdate");
