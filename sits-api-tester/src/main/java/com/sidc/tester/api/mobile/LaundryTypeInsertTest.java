...
public class LaundryTypeInsertTest {
	...
	public void test() throws Exception {
		...
		list.add(new LaundryLangBean("zh_TW", "photoTest", null));
		list.add(new LaundryLangBean("en_US", "photoTest", null));

		LaundryTypeInsertRequest request = new LaundryTypeInsertRequest("10204178-ca7b-4df7-94cc-0cd3c5d1694f", 1, list,
				photoList);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://10.60.1.39:7056/blackcore/sits/laundryservice/typeinsert");
