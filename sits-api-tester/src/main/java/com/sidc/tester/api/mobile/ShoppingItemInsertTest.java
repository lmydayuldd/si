...
public class ShoppingItemInsertTest {
	...
	public void test() throws Exception {
		...
		// list;
		// photolist;
		ShoppingItemInsertRequest request = new ShoppingItemInsertRequest("fbadf796-6626-4460-8066-d1e86d503579", 1, 1,
				"1", 10, (float) 100, (float) 100, 1000, (float) 1000, list, photoList);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://60.250.38.8:7056/blackcore/sits/shopping/iteminsert");
