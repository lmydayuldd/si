...
public class SpareCategoryInsertTest {
	...
	public void test() throws Exception {
		...
		list.add(new SpareLangBean("備品分類測試3", "zh_TW", "備品分類測試2."));
		list.add(new SpareLangBean("spare category test3", "en_US", "category2."));
		...
		SpareCategoryInsertRequest request = new SpareCategoryInsertRequest("86f6ffa3-2d69-4389-b044-664b2a3ba130", 1,
				12, list, photoList);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://10.60.1.39:7056/blackcore/sits/spare/categoryinsert");
