...
public class RcuModeInsertTest {
	...
	public void test() throws Exception {
		...
		RcuDeviceHvacSettingBean hvac = new RcuDeviceHvacSettingBean(false, 0, 0, 0, 0);
		...
		RcuGroupModeInsertRequest request = new RcuGroupModeInsertRequest(null, 1, 1, devices);
