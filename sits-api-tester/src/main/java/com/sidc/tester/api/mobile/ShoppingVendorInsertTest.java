...
public class ShoppingVendorInsertTest {
	...
	public void test() throws Exception {
		...
		ShoppingVendorInsertRequest request = new ShoppingVendorInsertRequest("4676208c-777b-48d9-bb80-48ca27722009", 1,
				"02dd2587441", "hihi@rd.com.tw", "台北2red", list);

		HttpClient httpclient = HttpClients.createDefault();
		HttpPost httppost = new HttpPost("http://125.227.184.56:7056/blackcore/sits/shopping/vendorinsert");
